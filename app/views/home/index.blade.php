...
<div class="row">
	<div class="col-sm-4 margin-bottom-20">
		<img class="img-responsive home-featured-img" src="{{url('/')}}/img/home-img{{rand(1,5)}}.jpg" alt="Alchin's Disposal, Inc.">
	</div>
	...
	<div class="col-sm-3">
		<a href="{{url('/')}}/contact" class="btn btn-block btn-lg btn-blue">Contact Us <span class="glyphicon glyphicon-menu-right"></span></a>
